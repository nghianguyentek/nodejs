function doSomething(callback) {
  ...
  .then(err => {
    ...
    process.nextTick(() => console.log("I'm the 1st process.nextTick's callback in an I/O callback"))
    queueMicrotask(callback)
    process.nextTick(() => console.log("I'm the 2nd process.nextTick's callback in an I/O callback"))
  })
...
doSomething(() => console.log("I'm an external callback in an I/O callback"))